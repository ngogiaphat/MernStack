  ...
  return(
    <Box m="1.5rem 2.5rem">
      ...
      >
        ...
        />
        <StatBox title="Sales Today" value={data && data.todayStats.totalSales} description="Since last month" icon={
            <PointOfSale sx={{ 
								color: theme.palette.secondary[300], 
								fontSize: "26px",
							}}
        ...
        />
        <StatBox title="Yearly Sales" value={data && data.yearlySalesTotal} increase="+43%" description="Since last month" icon={
            <Traffic sx={{ 
								color: theme.palette.secondary[300], 
								fontSize: "26px",
							}}
